...
public class DamageCalculator { 
	/**
	   ...
	   * @param entityStats Attribute must be defined in Entity
	   * @param ability 	Attribute must be defined in Champion
	   * @return 			Initial damage output 
	   */
	...
	/**
	   * Calculates initial damage from entity's stats
	   * @param initialDamage 	Integer must be greater than 0
	   * @param champion 		Must be a defined entity
	   * @param victim			Can be any entity
	   * @return 				Initial damage output 
	   */
